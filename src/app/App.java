...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Book b0 = new Book("The Burning Maze", 250, a4, 10.6, new Fiction("fantasy"), "9123567891220", 2018);
        ...
        Book b10 = new Book("Inferno", 450, a6, 10.6, new Fiction("thriller"), "9123567891219", 2013);
